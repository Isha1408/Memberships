...
namespace Memberships.Areas.Admin.Controllers
{
    public class ProductLinkTextController : Controller
    {
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            Entities.ProductLinkText productLinkText = await db.ProductLinkTexts.FindAsync(id);
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Title")] Entities.ProductLinkText productLinkText)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Title")] Entities.ProductLinkText productLinkText)
        {
            if (ModelState.IsValid)
            {
